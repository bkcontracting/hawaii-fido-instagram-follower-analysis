...
| 3-8 | Analyze batch 1-6 | AI analysis | `data/analysis_results/batch_N_results.json` |
| 9 | Aggregate results | AI aggregation | `data/all_analyzed_profiles.json` |
| 10 | Final ranking | AI ranking | `data/top_25_fundraising.json`, `data/top_15_marketing_partners.json` |
| 11 | Format reports | Python script | `output/fundraising_recommendations.md`, CSVs |

## Architecture

- **Shell script** (`run_analysis.sh`): Loops up to 15 iterations, calls Claude each time
...
- `data/analysis_batches/batch_*.json` - 6 batch files
- `data/analysis_results/batch_*_results.json` - 6 analyzed batch results

...
These examples define the scoring standard. Your scores should align with these benchmarks:

### Hawaiian Electric - Score ~90
- Entity type: `corporation`
- Financial capacity: 38/40 (TIER_A - major utility, CSR budget certain)
- Donor access: 20/25 (HIGH - employee giving programs, corporate network)
- Dinner potential: 18/20 (TABLE_BUYER - corporations buy tables)
- Hawaii connection: 14/15 (LOCAL_STRONG - est. 1891, serves all islands)
- Outreach: CORPORATE_SPONSORSHIP, $10K-$25K

### Rotary E-Club of Hawaii - Score ~88
- Entity type: `member_organization`
- Financial capacity: 25/40 (TIER_B - members are affluent, org itself moderate)
- Donor access: 25/25 (HIGH - 50+ wealthy business owner members)
- Dinner potential: 18/20 (TABLE_BUYER - Rotary clubs buy tables for events)
- Hawaii connection: 14/15 (LOCAL_STRONG - established Hawaii Rotary club)
- Outreach: MEMBER_PRESENTATION, then TABLE_PURCHASE

### North Shore Chamber of Commerce - Score ~83
- Entity type: `member_organization`
- Financial capacity: 20/40 (TIER_C - chamber itself moderate)
- Donor access: 24/25 (HIGH - 100+ business owner members)
- Dinner potential: 16/20 (TABLE_BUYER - chambers support local causes)
- Hawaii connection: 15/15 (LOCAL_STRONG - 100+ years, North Shore institution)
- Outreach: MEMBER_PRESENTATION, then TABLE_PURCHASE

### Sony Open in Hawaii - Score ~74
- Entity type: `media_event_org`
- Financial capacity: 15/40 (TIER_C - event org, not direct donor)
- Donor access: 22/25 (HIGH - corporate sponsors + wealthy golf community)
- Dinner potential: 12/20 (MULTI_TICKET - event org might send representatives)
- Hawaii connection: 15/15 (LOCAL_STRONG - major annual Hawaii event)
- Outreach: DOOR_OPENER, access to sponsor network

### Assistance Dogs of Hawaii - Score 0, SKIP
- Entity type: `EXCLUDE_competitor`
- Competitor: trains/places assistance dogs
- Score: 0, all factors: 0
- Outreach: SKIP

### Oahu SPCA - Score 0, SKIP
- Entity type: `EXCLUDE_nonprofit`
- Nonprofit: animal welfare charity that needs donations itself
- Score: 0, all factors: 0
- Outreach: SKIP

### Friends of Hawaii Charities - Score 0, SKIP
- Entity type: `EXCLUDE_nonprofit`
- Nonprofit: grantmaking foundation/charity
- Score: 0, all factors: 0
- Outreach: SKIP

### Random Dog Trainer (solo) - Score 0, SKIP
- Entity type: `EXCLUDE_pet_micro`
- Solo dog trainer, no employees, no physical location
- Score: 0, all factors: 0
- Outreach: SKIP
